...
* `/v1/pronunciation` returns the pronunciation for a specified word. The
`/v1/pronunciation` method is currently beta functionality.
...
speech synthesis. All `/v1/customizations` methods are currently beta functionality.
...
supported for use with the `POST /v1/synthesize` method. For examples of calls to this
method, see the [Text to Speech API
...
class TextToSpeechV1(WatsonService):
    ...
    def synthesize(self, text, accept, voice=None, customization_id=None):
        """
